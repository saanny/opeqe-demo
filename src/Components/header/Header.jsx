...
export default function Header() {
  ...
  const [colorBasket, setColorBasket] = useState("rgb(2, 103, 100)");
  useEffect(() => {
    window.onscroll = function () {
      ...
      if (top >= 200) {
        h1.style.backgroundColor = "rgb(207, 207, 207)";
        setColorBasket("rgb(105, 105, 105)");
      }
      if (top < 200) {
        h1.style.backgroundColor = "#efefef";
        setColorBasket("rgb(2, 103, 100)");
      }
    };
  });
        ...
        <Grid container justify="center">
          <Grid className="container" container direction="row" item justify="space-between" alignItems="center" xs={11}>
            <div className="header__logo-block">
              <a href="google.com" className="header__logo-link">
              ...
              <div className="header__menu">
                <Router>
                  {mdBreakPoint && (
                    <ul>
                      <li>
                        <RouterLink to="/location/beverly-hills/reservation/new">Reservation</RouterLink>
                      </li>

                      <>
                        <li>
                          <RouterLink to="/order-history">Orders</RouterLink>
                        </li>
                        <li>
                  ...
                  <>
                    ...
                    {mdBreakPoint && (
                      <Button component={RouterLink} to="/sign-up" size="small" className={classes.headerButtonSignUp}>
                        Sign Up
                      </Button>
                    )}
                  </>

                  <IconButton component={RouterLink} to="/sign-up" aria-label="basket" className="cart">
                    <ShoppingBasketIcon style={{ fontSize: 30, color: colorBasket }} />
                  </IconButton>
                </Router>
              </div>
            </>
